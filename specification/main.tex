...
iris-MSWasm paper\cite{iriswasm}.
\begin{align*}
...
Wasm. The $\cw{load}$ operation is not defined for the $\ptrt$ type, to avoid forgery.
\todo{$\new{\ptrt.store}$ could still be allowed, but should it?}
